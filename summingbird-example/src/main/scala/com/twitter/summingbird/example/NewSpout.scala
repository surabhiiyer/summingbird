...
/**
 * Created by surabhi.ravishankar on 18/03/14.
 */
...
class NewSpout extends StormSpout(outputFields = List("sentence"))  {
...
object WordCountTopology {
  def main(args: Array[String]) = {
    ...
    builder.setSpout("randsentence", new NewSpout, 5)
    builder.setBolt("split", new SpliStSentence, 8)
